...
public class AppConfig {
	...
	public SecurityFilterChain configuration(HttpSecurity http) throws Exception {
		...
		cors(cors ->{
			cors.configurationSource(new org.springframework.web.cors.CorsConfigurationSource(){
		...
		}) .authorizeHttpRequests(auth -> auth.requestMatchers(HttpMethod.POST , "/admin/register","/students/**").permitAll()
				...
				.requestMatchers(HttpMethod.GET,"/courses","/student-addresses/**").hasRole("ADMIN")
				.requestMatchers(HttpMethod.POST, "/courses/assignStudents/{courseId}/{uniqueStudentCode}","/courses","/students/register","/student-addresses/**").hasRole("ADMIN")
